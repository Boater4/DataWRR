...
for num in range(0,30): 
    ...
    with open('OptRes/HAN_NRI2u_RunTime.csv', 'a', newline='') as file:
    ...
    #导出决策变量和目标函数
    XF.to_csv(f"OptRes/HAN_NRI2u_seed{num}.csv")           
...
nXF.to_csv("opt30ResHAN/HAN1_NRI2u_opt30.csv")   #导出决策变量和目标函数    
