...
for num in range(0,30): 
    ...
    with open('OptRes/PES_NRI2u_RunTime.csv', 'a', newline='') as file:
    ...
    XF.to_csv(f"OptRes/PES_NRI2u_seed{num}.csv")   #导出决策变量和目标函数
...
nXF.to_csv("opt30Res/PES_NRI2u_opt30.csv")   #导出决策变量和目标函数  
