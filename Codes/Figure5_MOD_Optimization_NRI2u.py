...
for num in range(2,30): 
    ...
    with open('OptRes/MOD_NRI2u_RunTime.csv', 'a', newline='') as file:
    ...
    XF.to_csv(f"OptRes/MOD_NRI2u_seed{num}.csv")   #导出决策变量和目标函数
...
# nXF.to_csv("opt30ResMOD/MOD_NRI2u_opt30.csv")   #导出决策变量和目标函数  
