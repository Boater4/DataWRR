...
resList = ['15','43','65']
juncDegree = [i[1] for i in node_degree if i[0] not in resList] # Reservoir node '15','43','65'    
...
for num in range(0,30): 
    ...
    with open('OptRes/PES_NRI2uk_RunTime.csv', 'a', newline='') as file:
    ...
    XF.to_csv(f"OptRes/PES_NRI2uk_seed{num}.csv")   #导出决策变量和目标函数
...
nXF.to_csv("opt30Res/PES_NRI2uk_opt30.csv")   #导出决策变量和目标函数  
